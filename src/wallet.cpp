...
// cfacoin: total coins staked (non-spendable until maturity)
...
// cfacoin: get current stake weight
...
// cfacoin: check 'spent' consistency between wallet and txindex
// cfacoin: fix wallet spent state according to txindex
...
// cfacoin: disable transaction (only for coinstake)
