...
namespace Checkpoints
{
    ...
    // cfacoin: synchronized checkpoint (centrally broadcasted)
    ...
    // cfacoin: get last synchronized checkpoint
    ...
    // cfacoin: only descendant of current sync-checkpoint is allowed
    ...
    // cfacoin: reset synchronized checkpoint to last hardened checkpoint
...
// cfacoin: sync-checkpoint master key
...
// cfacoin: verify signature of sync-checkpoint message
...
// cfacoin: process synchronized checkpoint
