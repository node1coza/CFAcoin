    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("Cfacoin") + " - " + tr("Wallet"));
#ifdef Q_OS_LINUX
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Cfacoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Cfacoin"), this);
    aboutAction->setToolTip(tr("Show information about Cfacoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Cfacoin"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("background-color: #1A4E59; color: white");
#else
    //Windows/Mac - Set Purple tabs, white text, tooltips adjusted
    toolbar->setStyleSheet(" QToolTip { color: black; background-color: #1A4E59}; color: white; background-color: #1A4E59");
#endif
...
#ifdef Q_OS_LINUX
    //Linux - Set Purple tabs, white text, tooltips unaffected
    toolbar2->setStyleSheet("background-color: #1A4E59");
#else
    //Windows/Mac - Set Purple tabs, tooltips adjusted
    toolbar2->setStyleSheet(" QToolTip { color: black; background-color: #1A4E59}; background-color: #1A4E59");
#endif
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Cfacoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Cfacoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cfacoin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Cfacoin address or malformed URI parameters."));
    }
